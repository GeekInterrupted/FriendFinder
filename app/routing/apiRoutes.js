...
module.exports = function(app) {
    //api path to get the friends data, responds with an array of friends - json
    app.get('/api/friends', function(req, res) {
        res.json(friends);
    });

    //updates the array of friends and sends back the json form of the most compatible new friend
    app.post('/api/friends', function(req, res) {
        ...
        bestBuddy = friends[bestMatchIndex];
